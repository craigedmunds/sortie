...
func TestNormalizeSearchIssue_AllFields(t *testing.T) {
	...
	issue := normalizeSearchIssue("https://test.atlassian.net", ji, true)
...
func TestNormalizeSearchIssue_NonIntegerPriority(t *testing.T) {
	...
	issue := normalizeSearchIssue("https://x.atlassian.net", ji, true)
	if issue.Priority != nil {
...
func TestNormalizeComments(t *testing.T) {
	...
	t.Run("normal comments", func(t *testing.T) {
		...
		result := normalizeComments(comments, true)
		if len(result) != 1 {
	...
	t.Run("empty list", func(t *testing.T) {
		...
		result := normalizeComments([]jiraComment{}, true)
		if result == nil {
